...
const Header = () => {
  return (
    <header className={styles.header}>
      <div className={styles.div_span_portfolio}>
        <svg stroke="currentColor" fill="#fff" strokeWidth="0" version="1.1" viewBox="0 0 32 32" height="2rem" width="2rem" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className={styles.span_portfolio}>Portfolio</span>
      </div>

      <nav className={styles.header_nav}>
        <Link href="projetos">
          <a className={styles.link_nav}>Projetos</a>
        </Link>
        <Link href="tecnologias">
          <a className={styles.link_nav}>Tecnologias</a>
        </Link>
        <Link href="sobre">
          <a className={styles.link_nav}>Sobre</a>
        </Link>
      </nav>

      <nav className={styles.nav_socials}>
        <a className={styles.social_link} href="https://github.com/ewertonribeiro" target="_blank">
          <svg stroke="currentColor" fill="#fff" strokeWidth="0" viewBox="0 0 1024 1024" height="2rem" width="2rem" xmlns="http://www.w3.org/2000/svg">
        ...
        <a className={styles.social_link} href="https://www.linkedin.com/in/ewerton-ribeirozz" target="_blank">
          <svg stroke="currentColor" fill="#fff" strokeWidth="0" viewBox="0 0 1024 1024" height="2rem" width="2rem" xmlns="http://www.w3.org/2000/svg">
