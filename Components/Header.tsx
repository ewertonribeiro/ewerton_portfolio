  ...
  return (
    <header className={styles.header}>
      ...
      <nav className={styles.header_nav}>
        ...
        <Link Href="tecnologias" className={styles.link_nav}>
          Tecnologias
        </Link>
        <Link Href="sobre" className={styles.link_nav}>
          Sobre
        </Link>
      </nav>
      ...
      <nav className={styles.nav_socials}>
        <a
          ...
          href="https://github.com/ewertonribeiro"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          className={styles.social_link}
          href="https://www.linkedin.com/in/ewerton-ribeirozz"
          target="_blank"
          rel="noreferrer"
        >
          <svg
